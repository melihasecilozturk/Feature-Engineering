...
df_= pd.read_csv("/Users/melihasecilozturk/Desktop/miuul/ödevler/diabetes/diabetes.csv")
df = df_.copy()
df.head()
...
# fonksiyon bu şekilde güncellenebilir isterseniz. col name yerine direkt cat cols yazdı
...
##################################
# BASE MODEL KURULUMU ( HENÜZ ENCODE, OUTLIER DÜZENLEME VS YAPILMAMIŞ HALİ)
##################################
...
# STANDARTLAŞTIRMA
##################################
#nümerik kolonları 1 ile -1 arasında scale ediyo
num_cols
